...
# Actividad 1
# Implementacion del algoritmo de Booth para la multiplicacion con signo. Numeros de 32 bits.
# octubre 2019
...
.data
	...
	numA: .asciz  "A continuación inserte los numeros a multiplicar \nMultiplicando A: "
	numB: .asciz  "Multiplicador B: "
	msg_1: .asciz  "A * B\n"
	msg_2: .asciz  "HI = "
	msg_3: .asciz  "\nLO = "
	white: .asciz "\n------------------------------------\n"
	again: .asciz "\n\nIntentar de nuevo? Y = 1, N = 0. R = "
...
.text 
	...
	beq s1, a4, shift	# branch if LSB of P and LSB extra bit of P are equal, don´t add
